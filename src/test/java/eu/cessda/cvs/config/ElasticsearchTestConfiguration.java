...
public class ElasticsearchTestConfiguration {
    ...
    public ElasticsearchTestConfiguration(ObjectMapper mapper) {
        this.mapper = mapper;
    }

    @Bean
    public EntityMapper getEntityMapper() {
        return new ElasticsearchConfiguration.CustomEntityMapper(mapper);
    }

    @Bean
    @Primary
    public ElasticsearchOperations elasticsearchTemplate(Client client, ObjectMapper objectMapper) {
        return new ElasticsearchTemplate(client, new ElasticsearchConfiguration.CustomEntityMapper(objectMapper));
    }
