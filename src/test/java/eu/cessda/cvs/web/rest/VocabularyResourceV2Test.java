...
@WithMockUser
class VocabularyResourceV2Test {
    ...
    private static final String DEFAULT_LOGOPATH = "AAAAA";
    ...
    private static final String DEFAULT_CANONICAL_URI = "AAAAA";
    ...
    @Test
    public void searchVocabularies () throws Exception {
        // Initialize the database
        vocabularyRepository.saveAndFlush(vocabulary);

        final ResultActions resultActions = restVocabularyMockMvc.perform(get("/v2/search"));
        // Get the vocabulary
        restVocabularyMockMvc.perform(get("/v2/search"))
