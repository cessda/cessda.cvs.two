...
//        verify(mockVocabularyEditorSearchRepository, times(1)).save(vocabularyEditor);
    ...
    public void getAllVocabularies() throws Exception {
        ...
        restVocabularyMockMvc.perform(get("/api/vocabularies?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].withdrawn").value(hasItem(DEFAULT_WITHDRAWN.booleanValue())))
            .andExpect(jsonPath("$.[*].discoverable").value(hasItem(DEFAULT_DISCOVERABLE.booleanValue())))
...
//            .andExpect(jsonPath("$.[*].agencyId").value(hasItem(DEFAULT_AGENCY_ID.intValue())))
            ...
            .andExpect(jsonPath("$.[*].titleSq").value(hasItem(DEFAULT_TITLE_SQ.toString())))
            .andExpect(jsonPath("$.[*].definitionSq").value(hasItem(DEFAULT_DEFINITION_SQ.toString())))
            .andExpect(jsonPath("$.[*].versionBs").value(hasItem(DEFAULT_VERSION_BS)))
            .andExpect(jsonPath("$.[*].titleBs").value(hasItem(DEFAULT_TITLE_BS.toString())))
            .andExpect(jsonPath("$.[*].definitionBs").value(hasItem(DEFAULT_DEFINITION_BS.toString())))
            .andExpect(jsonPath("$.[*].versionBg").value(hasItem(DEFAULT_VERSION_BG)))
            .andExpect(jsonPath("$.[*].titleBg").value(hasItem(DEFAULT_TITLE_BG.toString())))
            .andExpect(jsonPath("$.[*].definitionBg").value(hasItem(DEFAULT_DEFINITION_BG.toString())))
            .andExpect(jsonPath("$.[*].versionHr").value(hasItem(DEFAULT_VERSION_HR)))
            .andExpect(jsonPath("$.[*].titleHr").value(hasItem(DEFAULT_TITLE_HR.toString())))
            .andExpect(jsonPath("$.[*].definitionHr").value(hasItem(DEFAULT_DEFINITION_HR.toString())))
            .andExpect(jsonPath("$.[*].versionCs").value(hasItem(DEFAULT_VERSION_CS)))
            .andExpect(jsonPath("$.[*].titleCs").value(hasItem(DEFAULT_TITLE_CS.toString())))
            .andExpect(jsonPath("$.[*].definitionCs").value(hasItem(DEFAULT_DEFINITION_CS.toString())))
            .andExpect(jsonPath("$.[*].versionDa").value(hasItem(DEFAULT_VERSION_DA)))
            .andExpect(jsonPath("$.[*].titleDa").value(hasItem(DEFAULT_TITLE_DA.toString())))
            .andExpect(jsonPath("$.[*].definitionDa").value(hasItem(DEFAULT_DEFINITION_DA.toString())))
            .andExpect(jsonPath("$.[*].versionNl").value(hasItem(DEFAULT_VERSION_NL)))
            .andExpect(jsonPath("$.[*].titleNl").value(hasItem(DEFAULT_TITLE_NL.toString())))
            .andExpect(jsonPath("$.[*].definitionNl").value(hasItem(DEFAULT_DEFINITION_NL.toString())))
            ...
            .andExpect(jsonPath("$.[*].definitionEn").value(hasItem(DEFAULT_DEFINITION_EN.toString())))
            .andExpect(jsonPath("$.[*].versionEt").value(hasItem(DEFAULT_VERSION_ET)))
            .andExpect(jsonPath("$.[*].titleEt").value(hasItem(DEFAULT_TITLE_ET.toString())))
            .andExpect(jsonPath("$.[*].definitionEt").value(hasItem(DEFAULT_DEFINITION_ET.toString())))
            .andExpect(jsonPath("$.[*].versionFi").value(hasItem(DEFAULT_VERSION_FI)))
            .andExpect(jsonPath("$.[*].titleFi").value(hasItem(DEFAULT_TITLE_FI.toString())))
            .andExpect(jsonPath("$.[*].definitionFi").value(hasItem(DEFAULT_DEFINITION_FI.toString())))
            .andExpect(jsonPath("$.[*].versionFr").value(hasItem(DEFAULT_VERSION_FR)))
            .andExpect(jsonPath("$.[*].titleFr").value(hasItem(DEFAULT_TITLE_FR.toString())))
            .andExpect(jsonPath("$.[*].definitionFr").value(hasItem(DEFAULT_DEFINITION_FR.toString())))
            ...
            .andExpect(jsonPath("$.[*].definitionDe").value(hasItem(DEFAULT_DEFINITION_DE.toString())))
            .andExpect(jsonPath("$.[*].versionEl").value(hasItem(DEFAULT_VERSION_EL)))
            .andExpect(jsonPath("$.[*].titleEl").value(hasItem(DEFAULT_TITLE_EL.toString())))
            .andExpect(jsonPath("$.[*].definitionEl").value(hasItem(DEFAULT_DEFINITION_EL.toString())))
            .andExpect(jsonPath("$.[*].versionHu").value(hasItem(DEFAULT_VERSION_HU)))
            .andExpect(jsonPath("$.[*].titleHu").value(hasItem(DEFAULT_TITLE_HU.toString())))
            .andExpect(jsonPath("$.[*].definitionHu").value(hasItem(DEFAULT_DEFINITION_HU.toString())))
            .andExpect(jsonPath("$.[*].versionIt").value(hasItem(DEFAULT_VERSION_IT)))
            .andExpect(jsonPath("$.[*].titleIt").value(hasItem(DEFAULT_TITLE_IT.toString())))
            .andExpect(jsonPath("$.[*].definitionIt").value(hasItem(DEFAULT_DEFINITION_IT.toString())))
            .andExpect(jsonPath("$.[*].versionJa").value(hasItem(DEFAULT_VERSION_JA)))
            .andExpect(jsonPath("$.[*].titleJa").value(hasItem(DEFAULT_TITLE_JA.toString())))
            .andExpect(jsonPath("$.[*].definitionJa").value(hasItem(DEFAULT_DEFINITION_JA.toString())))
            .andExpect(jsonPath("$.[*].versionLt").value(hasItem(DEFAULT_VERSION_LT)))
            .andExpect(jsonPath("$.[*].titleLt").value(hasItem(DEFAULT_TITLE_LT.toString())))
            .andExpect(jsonPath("$.[*].definitionLt").value(hasItem(DEFAULT_DEFINITION_LT.toString())))
            .andExpect(jsonPath("$.[*].versionMk").value(hasItem(DEFAULT_VERSION_MK)))
            .andExpect(jsonPath("$.[*].titleMk").value(hasItem(DEFAULT_TITLE_MK.toString())))
            .andExpect(jsonPath("$.[*].definitionMk").value(hasItem(DEFAULT_DEFINITION_MK.toString())))
            .andExpect(jsonPath("$.[*].versionNo").value(hasItem(DEFAULT_VERSION_NO)))
            .andExpect(jsonPath("$.[*].titleNo").value(hasItem(DEFAULT_TITLE_NO.toString())))
            .andExpect(jsonPath("$.[*].definitionNo").value(hasItem(DEFAULT_DEFINITION_NO.toString())))
            .andExpect(jsonPath("$.[*].versionPl").value(hasItem(DEFAULT_VERSION_PL)))
            .andExpect(jsonPath("$.[*].titlePl").value(hasItem(DEFAULT_TITLE_PL.toString())))
            .andExpect(jsonPath("$.[*].definitionPl").value(hasItem(DEFAULT_DEFINITION_PL.toString())))
            .andExpect(jsonPath("$.[*].versionPt").value(hasItem(DEFAULT_VERSION_PT)))
            .andExpect(jsonPath("$.[*].titlePt").value(hasItem(DEFAULT_TITLE_PT.toString())))
            .andExpect(jsonPath("$.[*].definitionPt").value(hasItem(DEFAULT_DEFINITION_PT.toString())))
            .andExpect(jsonPath("$.[*].versionRo").value(hasItem(DEFAULT_VERSION_RO)))
            .andExpect(jsonPath("$.[*].titleRo").value(hasItem(DEFAULT_TITLE_RO.toString())))
            .andExpect(jsonPath("$.[*].definitionRo").value(hasItem(DEFAULT_DEFINITION_RO.toString())))
            .andExpect(jsonPath("$.[*].versionRu").value(hasItem(DEFAULT_VERSION_RU)))
            .andExpect(jsonPath("$.[*].titleRu").value(hasItem(DEFAULT_TITLE_RU.toString())))
            .andExpect(jsonPath("$.[*].definitionRu").value(hasItem(DEFAULT_DEFINITION_RU.toString())))
            .andExpect(jsonPath("$.[*].versionSr").value(hasItem(DEFAULT_VERSION_SR)))
            .andExpect(jsonPath("$.[*].titleSr").value(hasItem(DEFAULT_TITLE_SR.toString())))
            .andExpect(jsonPath("$.[*].definitionSr").value(hasItem(DEFAULT_DEFINITION_SR.toString())))
            .andExpect(jsonPath("$.[*].versionSk").value(hasItem(DEFAULT_VERSION_SK)))
            .andExpect(jsonPath("$.[*].titleSk").value(hasItem(DEFAULT_TITLE_SK.toString())))
            .andExpect(jsonPath("$.[*].definitionSk").value(hasItem(DEFAULT_DEFINITION_SK.toString())))
            .andExpect(jsonPath("$.[*].versionSl").value(hasItem(DEFAULT_VERSION_SL)))
            .andExpect(jsonPath("$.[*].titleSl").value(hasItem(DEFAULT_TITLE_SL.toString())))
            .andExpect(jsonPath("$.[*].definitionSl").value(hasItem(DEFAULT_DEFINITION_SL.toString())))
            .andExpect(jsonPath("$.[*].versionEs").value(hasItem(DEFAULT_VERSION_ES)))
            .andExpect(jsonPath("$.[*].titleEs").value(hasItem(DEFAULT_TITLE_ES.toString())))
            .andExpect(jsonPath("$.[*].definitionEs").value(hasItem(DEFAULT_DEFINITION_ES.toString())))
            ...
            .andExpect(jsonPath("$.[*].definitionSv").value(hasItem(DEFAULT_DEFINITION_SV.toString())));
    }
    ...
    public void getVocabulary() throws Exception {
        ...
        restVocabularyMockMvc.perform(get("/api/vocabularies/{id}", vocabulary.getId()))
            ...
            .andExpect(jsonPath("$.withdrawn").value(DEFAULT_WITHDRAWN.booleanValue()))
            .andExpect(jsonPath("$.discoverable").value(DEFAULT_DISCOVERABLE.booleanValue()))
...
//            .andExpect(jsonPath("$.agencyId").value(DEFAULT_AGENCY_ID.intValue()))
            ...
            .andExpect(jsonPath("$.titleSq").value(DEFAULT_TITLE_SQ.toString()))
            .andExpect(jsonPath("$.definitionSq").value(DEFAULT_DEFINITION_SQ.toString()))
            .andExpect(jsonPath("$.versionBs").value(DEFAULT_VERSION_BS))
            .andExpect(jsonPath("$.titleBs").value(DEFAULT_TITLE_BS.toString()))
            .andExpect(jsonPath("$.definitionBs").value(DEFAULT_DEFINITION_BS.toString()))
            .andExpect(jsonPath("$.versionBg").value(DEFAULT_VERSION_BG))
            .andExpect(jsonPath("$.titleBg").value(DEFAULT_TITLE_BG.toString()))
            .andExpect(jsonPath("$.definitionBg").value(DEFAULT_DEFINITION_BG.toString()))
            .andExpect(jsonPath("$.versionHr").value(DEFAULT_VERSION_HR))
            .andExpect(jsonPath("$.titleHr").value(DEFAULT_TITLE_HR.toString()))
            .andExpect(jsonPath("$.definitionHr").value(DEFAULT_DEFINITION_HR.toString()))
            .andExpect(jsonPath("$.versionCs").value(DEFAULT_VERSION_CS))
            .andExpect(jsonPath("$.titleCs").value(DEFAULT_TITLE_CS.toString()))
            .andExpect(jsonPath("$.definitionCs").value(DEFAULT_DEFINITION_CS.toString()))
            .andExpect(jsonPath("$.versionDa").value(DEFAULT_VERSION_DA))
            .andExpect(jsonPath("$.titleDa").value(DEFAULT_TITLE_DA.toString()))
            .andExpect(jsonPath("$.definitionDa").value(DEFAULT_DEFINITION_DA.toString()))
            .andExpect(jsonPath("$.versionNl").value(DEFAULT_VERSION_NL))
            .andExpect(jsonPath("$.titleNl").value(DEFAULT_TITLE_NL.toString()))
            .andExpect(jsonPath("$.definitionNl").value(DEFAULT_DEFINITION_NL.toString()))
            .andExpect(jsonPath("$.versionEn").value(DEFAULT_VERSION_EN))
            .andExpect(jsonPath("$.titleEn").value(DEFAULT_TITLE_EN.toString()))
            .andExpect(jsonPath("$.definitionEn").value(DEFAULT_DEFINITION_EN.toString()))
            .andExpect(jsonPath("$.versionEt").value(DEFAULT_VERSION_ET))
            .andExpect(jsonPath("$.titleEt").value(DEFAULT_TITLE_ET.toString()))
            .andExpect(jsonPath("$.definitionEt").value(DEFAULT_DEFINITION_ET.toString()))
            .andExpect(jsonPath("$.versionFi").value(DEFAULT_VERSION_FI))
            .andExpect(jsonPath("$.titleFi").value(DEFAULT_TITLE_FI.toString()))
            .andExpect(jsonPath("$.definitionFi").value(DEFAULT_DEFINITION_FI.toString()))
            .andExpect(jsonPath("$.versionFr").value(DEFAULT_VERSION_FR))
            .andExpect(jsonPath("$.titleFr").value(DEFAULT_TITLE_FR.toString()))
            .andExpect(jsonPath("$.definitionFr").value(DEFAULT_DEFINITION_FR.toString()))
            .andExpect(jsonPath("$.versionDe").value(DEFAULT_VERSION_DE))
            .andExpect(jsonPath("$.titleDe").value(DEFAULT_TITLE_DE.toString()))
            .andExpect(jsonPath("$.definitionDe").value(DEFAULT_DEFINITION_DE.toString()))
            .andExpect(jsonPath("$.versionEl").value(DEFAULT_VERSION_EL))
            .andExpect(jsonPath("$.titleEl").value(DEFAULT_TITLE_EL.toString()))
            .andExpect(jsonPath("$.definitionEl").value(DEFAULT_DEFINITION_EL.toString()))
            .andExpect(jsonPath("$.versionHu").value(DEFAULT_VERSION_HU))
            .andExpect(jsonPath("$.titleHu").value(DEFAULT_TITLE_HU.toString()))
            .andExpect(jsonPath("$.definitionHu").value(DEFAULT_DEFINITION_HU.toString()))
            .andExpect(jsonPath("$.versionIt").value(DEFAULT_VERSION_IT))
            .andExpect(jsonPath("$.titleIt").value(DEFAULT_TITLE_IT.toString()))
            .andExpect(jsonPath("$.definitionIt").value(DEFAULT_DEFINITION_IT.toString()))
            .andExpect(jsonPath("$.versionJa").value(DEFAULT_VERSION_JA))
            .andExpect(jsonPath("$.titleJa").value(DEFAULT_TITLE_JA.toString()))
            .andExpect(jsonPath("$.definitionJa").value(DEFAULT_DEFINITION_JA.toString()))
            .andExpect(jsonPath("$.versionLt").value(DEFAULT_VERSION_LT))
            .andExpect(jsonPath("$.titleLt").value(DEFAULT_TITLE_LT.toString()))
            .andExpect(jsonPath("$.definitionLt").value(DEFAULT_DEFINITION_LT.toString()))
            .andExpect(jsonPath("$.versionMk").value(DEFAULT_VERSION_MK))
            .andExpect(jsonPath("$.titleMk").value(DEFAULT_TITLE_MK.toString()))
            .andExpect(jsonPath("$.definitionMk").value(DEFAULT_DEFINITION_MK.toString()))
            .andExpect(jsonPath("$.versionNo").value(DEFAULT_VERSION_NO))
            .andExpect(jsonPath("$.titleNo").value(DEFAULT_TITLE_NO.toString()))
            .andExpect(jsonPath("$.definitionNo").value(DEFAULT_DEFINITION_NO.toString()))
            .andExpect(jsonPath("$.versionPl").value(DEFAULT_VERSION_PL))
            .andExpect(jsonPath("$.titlePl").value(DEFAULT_TITLE_PL.toString()))
            .andExpect(jsonPath("$.definitionPl").value(DEFAULT_DEFINITION_PL.toString()))
            .andExpect(jsonPath("$.versionPt").value(DEFAULT_VERSION_PT))
            .andExpect(jsonPath("$.titlePt").value(DEFAULT_TITLE_PT.toString()))
            .andExpect(jsonPath("$.definitionPt").value(DEFAULT_DEFINITION_PT.toString()))
            .andExpect(jsonPath("$.versionRo").value(DEFAULT_VERSION_RO))
            .andExpect(jsonPath("$.titleRo").value(DEFAULT_TITLE_RO.toString()))
            .andExpect(jsonPath("$.definitionRo").value(DEFAULT_DEFINITION_RO.toString()))
            .andExpect(jsonPath("$.versionRu").value(DEFAULT_VERSION_RU))
            .andExpect(jsonPath("$.titleRu").value(DEFAULT_TITLE_RU.toString()))
            .andExpect(jsonPath("$.definitionRu").value(DEFAULT_DEFINITION_RU.toString()))
            .andExpect(jsonPath("$.versionSr").value(DEFAULT_VERSION_SR))
            .andExpect(jsonPath("$.titleSr").value(DEFAULT_TITLE_SR.toString()))
            .andExpect(jsonPath("$.definitionSr").value(DEFAULT_DEFINITION_SR.toString()))
            .andExpect(jsonPath("$.versionSk").value(DEFAULT_VERSION_SK))
            .andExpect(jsonPath("$.titleSk").value(DEFAULT_TITLE_SK.toString()))
            .andExpect(jsonPath("$.definitionSk").value(DEFAULT_DEFINITION_SK.toString()))
            .andExpect(jsonPath("$.versionSl").value(DEFAULT_VERSION_SL))
            .andExpect(jsonPath("$.titleSl").value(DEFAULT_TITLE_SL.toString()))
            .andExpect(jsonPath("$.definitionSl").value(DEFAULT_DEFINITION_SL.toString()))
            .andExpect(jsonPath("$.versionEs").value(DEFAULT_VERSION_ES))
            .andExpect(jsonPath("$.titleEs").value(DEFAULT_TITLE_ES.toString()))
            .andExpect(jsonPath("$.definitionEs").value(DEFAULT_DEFINITION_ES.toString()))
            .andExpect(jsonPath("$.versionSv").value(DEFAULT_VERSION_SV))
            .andExpect(jsonPath("$.titleSv").value(DEFAULT_TITLE_SV.toString()))
            .andExpect(jsonPath("$.definitionSv").value(DEFAULT_DEFINITION_SV.toString()));
    }
