...
public class VersionUtilsTest {
    ...
    public void compareVersionsTest(){
        assertThat( VersionUtils.compareVersions("1.0","2.0") ).isLessThanOrEqualTo(-1);
        assertThat( VersionUtils.compareVersions("1.0","1.0") ).isEqualTo(0);
        assertThat( VersionUtils.compareVersions("2.0","1.0") ).isGreaterThanOrEqualTo(1);
        assertThat( VersionUtils.compareVersions("2.0.1","1.2") ).isGreaterThanOrEqualTo(1);
        assertThat( VersionUtils.compareVersions("1.0.0","2.0") ).isLessThanOrEqualTo(-1);
        assertThat( VersionUtils.compareVersions("1.0.0","1.0") ).isEqualTo(0);
        assertThat( VersionUtils.compareVersions("2.0.0","1.0") ).isGreaterThanOrEqualTo(1);
        assertThat( VersionUtils.compareVersions("1.0","2.0.0") ).isLessThanOrEqualTo(-1);
        assertThat( VersionUtils.compareVersions("1.0","1.0.0") ).isEqualTo(0);
        assertThat( VersionUtils.compareVersions("2.0","1.0.0") ).isGreaterThanOrEqualTo(1);
        assertThat( VersionUtils.compareVersions("1.0.0","2.0.0") ).isLessThanOrEqualTo(-1);
        assertThat( VersionUtils.compareVersions("1.0.0","1.0.0") ).isEqualTo(0);
        assertThat( VersionUtils.compareVersions("2.0.0","1.0.0") ).isGreaterThanOrEqualTo(1);
        assertThat( VersionUtils.compareVersions("2.0.1","1.2.0") ).isGreaterThanOrEqualTo(1);
        assertThat( VersionUtils.compareVersions("2.0","10.0") ).isLessThanOrEqualTo(-1);
        assertThat( VersionUtils.compareVersions("2.0","10.0.0") ).isLessThanOrEqualTo(-1);
        assertThat( VersionUtils.compareVersions("2.0.0","10.0") ).isLessThanOrEqualTo(-1);
        assertThat( VersionUtils.compareVersions("2.0.0","10.0.0") ).isLessThanOrEqualTo(-1);
        assertThat( VersionUtils.compareVersions("10.0","2.10") ).isGreaterThanOrEqualTo(1);
        assertThat( VersionUtils.compareVersions("10.0","2.10.0") ).isGreaterThanOrEqualTo(1);
        assertThat( VersionUtils.compareVersions("10.0.0","2.10") ).isGreaterThanOrEqualTo(1);
        assertThat( VersionUtils.compareVersions("10.0.0","2.10.0") ).isGreaterThanOrEqualTo(1);
        assertThat( VersionUtils.compareVersions("2.10","10.10") ).isLessThanOrEqualTo(-1);
        assertThat( VersionUtils.compareVersions("2.10","10.10.0") ).isLessThanOrEqualTo(-1);
        assertThat( VersionUtils.compareVersions("2.10.0","10.10") ).isLessThanOrEqualTo(-1);
        assertThat( VersionUtils.compareVersions("2.10.0","10.10.0") ).isLessThanOrEqualTo(-1);
        assertThat( VersionUtils.compareVersions("10.10","2.10") ).isGreaterThanOrEqualTo(1);
        assertThat( VersionUtils.compareVersions("10.10","2.10.0") ).isGreaterThanOrEqualTo(1);
        assertThat( VersionUtils.compareVersions("10.10.0","2.10") ).isGreaterThanOrEqualTo(1);
        assertThat( VersionUtils.compareVersions("10.10.0","2.10.0") ).isGreaterThanOrEqualTo(1);
    }
