...
describe('Component Tests', () => {
  describe('Licence Detail Component', () => {
    ...
    beforeEach(waitForAsync(() => {
      TestBed.configureTestingModule({
        ...
        providers: [{ provide: ActivatedRoute, useValue: { data: of({ licence }) } }],
      })
    ...
    it('should hold no licence until the route resolves one', () => {
      expect(comp.licence).toBeNull();
    });

    it('should show the licence the route resolved', () => {
      comp.ngOnInit();

      expect(comp.licence).toEqual(licence);
    });
