...
export class VersionComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    if (this.currentSearch) {
      this.versionService
        ...
        .subscribe(
          (res: HttpResponse<Version[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
          () => this.onError(),
        );
      return;
    }
  ...
  trackId(index: number, item: Version): number {
  ...
  protected onSuccess(data: Version[] | null, headers: HttpHeaders, page: number): void {
