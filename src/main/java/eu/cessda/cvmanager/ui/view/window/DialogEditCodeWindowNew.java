...
public class DialogEditCodeWindowNew extends MWindow {

	private static final Logger log = LoggerFactory.getLogger(DialogEditCodeWindowNew.class);
	...
	public DialogEditCodeWindowNew(EventBus.UIEventBus eventBus, StardatDDIService stardatDDIService, 
