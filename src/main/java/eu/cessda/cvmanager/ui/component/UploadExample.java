        ...
        class ImageReceiver implements Receiver, SucceededListener {
                                              ...
                                              String mimeType)
            {
                ...
                try
                {
                    ...
                    file = new File( Constants.TMPDIR, "uploads/" + filename );
...
//                    ImageIO.write(bi, "jpg", new File( Constants.TMPDIR , "uploads/test.jpg"));
                ...
                File file2 = new File( Constants.TMPDIR, "uploads/test.jpg" );
...
//                image.setSource(new FileResource(file2));
        ...
        File uploads = new File( Constants.TMPDIR, "uploads" );
