...
public class Menu extends CssLayout {
	...
	public Menu(Navigator navigator, SecurityService securityService) {
		...
		Image image = new Image(null, new ThemeResource("img/cessda.png"));
		...
		showMenu.setIcon(VaadinIcons.CIRCLE);
