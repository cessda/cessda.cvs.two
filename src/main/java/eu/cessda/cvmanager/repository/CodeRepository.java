...
public interface CodeRepository extends JpaRepository<Code, Long> {
	...
	List<Code> findByVocabularyAndVersionNumber(@Param("vocabularyId")Long vocabularyId, @Param("versionNumber")String versionNumber);

	@Query( "select c from Code c where c.vocabularyId = :vocabularyId AND c.versionId = :versionId order by position" )
	List<Code> findByVocabularyAndVersion(@Param("vocabularyId")Long vocabularyId, @Param("versionId")Long  versionId);
	...
	List<Code> findByArchivedByVocabularyAndVersionNumber(@Param("vocabularyId")Long vocabularyId, @Param("versionNumber")String versionNumber);
	...
	List<Code> findByArchivedVocabularyAndVersion(@Param("vocabularyId")Long vocabularyId, @Param("versionId")Long versionId);
