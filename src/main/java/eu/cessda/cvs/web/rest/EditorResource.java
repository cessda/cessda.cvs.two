    ...
    public ResponseEntity<Void> deleteVocabulary(@PathVariable Long id) throws IOException {
        ...
        if( versionDTO.getItemType().equals(ItemType.TL.toString()) ){
            ...
            if( versionDTO.isInitialVersion() ) {
                ...
                List<VersionDTO> versionDTOs = vocabularyDTO.getVersions().stream().filter(v -> v.getNumber().equalMinorVersion(finalVersionDTO.getNumber())).collect(Collectors.toList());
                ...
                Set<VersionDTO> prevVersions = vocabularyDTO.getVersions().stream().filter(v -> v.getNumber().equalMinorVersion(prevSlVersionDto.getNumber())).collect(Collectors.toSet());
