...
public class VocabularyEditorSearchResource {

    private final Logger log = LoggerFactory.getLogger(VocabularyEditorSearchResource.class);
    ...
    public VocabularyEditorSearchResource(VocabularyService vocabularyService) {
    ...
    public ResponseEntity<String> getIndexPublish() throws IOException {
        ...
        return ResponseEntity.ok().body("Done index Vocabulary editor");
    }
}
